    ...
    <div className="p-6 bg-slate-50 min-h-full">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {FREE_COURSES.map((course: FreeCourse) => (
          <div key={course.id} className="bg-white rounded-lg shadow-lg overflow-hidden group transform transition-transform hover:-translate-y-2 duration-300">
            ...
            <div className="p-5">
              ...
              <p className="text-sm text-gray-600 mt-2 h-10">{course.description}</p>
